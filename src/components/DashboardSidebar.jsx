...
const DashboardSidebar = () => {
  ...
  return (
    <aside className="h-fit sm:min-h-[calc(100vh-110px)] w-full sm:sticky sm:top-26 p-5 rounded-lg border bg-linear-to-br from-white via-slate-100 to-slate-50 flex flex-col gap-1">
